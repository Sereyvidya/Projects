...
sub_logical: 	# Stores Difference in $v0
...
add_logical:	# Stores Addition in $v0 and Carry-out in $v1
	...
	add_sub_loop:	
	beq 	$s0, 32, add_sub_return 	# If n is 32, terminate loop
	...
	j	add_sub_loop			# Continue with loop
...
mul_logical:	# Stores Product in $v0(HI) and $v1(LO)
