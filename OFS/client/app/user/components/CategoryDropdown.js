...
const CategoryDropdown = () => {
  ...
  return (
    <div ref={dropdownRef} className="relative inline-block w-37 text-left">
      <div
      ...
      {openDropdown && (
        <div className="absolute z-10 mt-2 max-h-60 w-full overflow-y-auto rounded-md border-2 border-gray-300 bg-[#f1f0e9] shadow-lg focus:outline-gray-400">
          {categories.map((cat) => (
            <div
              key={cat}
              onClick={() => {
